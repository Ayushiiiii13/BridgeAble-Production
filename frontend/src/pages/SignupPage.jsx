        ...
        <div className="w-full max-w-md">
          <div className="card-warm p-8 shadow-warm-xl border-2 border-[#EADCC8]">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-[#5A3E2B] brand-font">Join BridgeAble</h1>
              <p className="text-sm text-[#7D7167] mt-1">Start connecting without communication barriers</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <User className="w-4 h-4 text-[#7D7167] absolute left-3.5 top-3.5" />
                  <input
                    type="text"
                    required
                    value={formData.name}
            ...
            <div className="mt-6 pt-6 border-t border-[#EADCC8] text-center text-xs text-[#7D7167]">
              ...
              <Link to="/login" className="text-[#5A3E2B] font-bold hover:underline">
                Sign in
              </Link>
            </div>
          </div>
